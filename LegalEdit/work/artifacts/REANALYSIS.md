...
(`work/paper/main.tex`) when it was restructured around the **LegalEdit**
...
Every figure below is reproduced by the pipeline in `work/src/`. Where the
...
|---|---|---|
| JudgeBERT-Scalar (repro) | 0.542 ± 0.082 | — |
